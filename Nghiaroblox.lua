...
local Library = Update:Window("Nghĩa Roblox","",Enum.KeyCode.RightControl);
...
K:AddSeperator("Sự Kiện Thủy Quái (Not Work)")
 
K:AddToggle('Auto Thủy Quái', false, function(value)
...
Misc:AddToggle("Graphic",false,function(v)
			if v then
				...
				a.Ambient = Color3.fromRGB(0, 105, 255)
				a.Brightness = 0.3
				a.ColorShift_Bottom = Color3.fromRGB(0, 105, 255)
				a.ColorShift_Top = Color3.fromRGB(0, 105, 255)
...
Misc:AddToggle("Esp Quái", false, function(nec)
    ...
    Misc:AddToggle("Auto Bật Tộc V3/Auto Active Race",_G.AutoAgility,function(value)
    ...
    Misc:AddToggle("Vô Hạn Tốc Biến/Infinite Soru",getgenv().InfSoru,function(value)
    ...
    Misc:AddToggle("Đi Trên Nước/Walk on Water",true,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:AddToggle("Xuyên Tường/NoClip",_G.NOCLIP,function(value)
        _G.NOCLIP = value
    end)
    ...
    Misc:AddButton("Xóa Dung Nham/Remove Lava",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
